...
public class TenCloudAnalytic {
    ...
    private String createTenAccess(String action, String apiAddr, TreeMap<String, String> urlArgs){
        ...
        String request_result = PrcUtils.doHttpsPost(PROTOCOL + CNS_DOMAIN + apiAddr, urlArgs);
...
//        urlArgs.put("mx", "1");
        ...
        System.out.printf(recordModify);
    }
     ...
     * @return
     */
    private static String createSignature(String method, String apiAddr, TreeMap treeMap){
        ...
        String signature = HmacSHA1.genHMAC(accessToSign, SECRET_KEY);
        return signature;
    }
